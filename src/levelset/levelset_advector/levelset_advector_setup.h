...
namespace LevelsetAdvectorSetup {
   ...
   /**
    * @brief Function returning the typedef of a LevelsetAdvector based on a constexpr template.
    * 
    * @tparam LevelsetAdvectors The constexpr template parameter to specify the exact LevelsetAdvector type.
    */
   template<LevelsetAdvectors>
   struct Concretize;
    ...
    */
   template<>
   struct Concretize<LevelsetAdvectors::DerivativeStencil> {
