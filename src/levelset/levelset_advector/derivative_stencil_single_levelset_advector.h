...
/**
 * @brief The DerivativeStencilSingleLevelsetAdvector propagates a single-level set field in time.
 */
class DerivativeStencilSingleLevelsetAdvector : public LevelsetAdvector<DerivativeStencilSingleLevelsetAdvector> {
