...
/**
 * @brief The ReconstructionStencilSingleLevelsetAdvector propagates a single-level set field in time.
 */
class ReconstructionStencilSingleLevelsetAdvector : public LevelsetAdvector<ReconstructionStencilSingleLevelsetAdvector> {
