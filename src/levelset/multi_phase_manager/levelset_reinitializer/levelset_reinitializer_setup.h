...
namespace LevelsetReinitializerSetup {
   ...
   /**
    * @brief Function returning the typedef of a LevelsetReinitializer based on a constexpr template.
    * @tparam LevelsetReinitializers The constexpr template parameter to specify the exact LevelsetReinitializer type.
    */
   template<LevelsetReinitializers>
   struct Concretize;
    ...
    */
   template<>
   struct Concretize<LevelsetReinitializers::Weno> {
    ...
    */
   template<>
   struct Concretize<LevelsetReinitializers::Min> {
