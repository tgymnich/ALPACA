...
/**
 * @brief Provides functionality to reinitialize a level-set field as described in \cite Sussman1994.
 */
class MinIterativeLevelsetReinitializer : public IterativeLevelsetReinitializerBase<MinIterativeLevelsetReinitializer> {
