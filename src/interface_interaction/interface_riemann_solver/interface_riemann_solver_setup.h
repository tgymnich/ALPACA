...
namespace InterfaceRiemannSolverSetup {
   ...
   /**
    * @brief Function returning the typedef of a InterfaceRiemannSolver based on a constexpr template.
    * 
    * @tparam InterfaceRiemannSolvers The constexpr template parameter to specify the exact InterfaceRiemannSolver type.
    */
   template<InterfaceRiemannSolvers>
   struct Concretize;
    ...
    */
   template<>
   struct Concretize<InterfaceRiemannSolvers::Linearized> {
    ...
    */
   template<>
   struct Concretize<InterfaceRiemannSolvers::Exact> {
    ...
    */
   template<>
   struct Concretize<InterfaceRiemannSolvers::TwoRarefaction> {
    ...
    */
   template<>
   struct Concretize<InterfaceRiemannSolvers::Hllc> {
