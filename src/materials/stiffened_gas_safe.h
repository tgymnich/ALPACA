...
/**
 * @brief The StiffenedGasSafe class implements a generic stiffened gas, i.e. material parameters must be set via caller input.
 *        Safe version, i.e. uses epsilons to avoid floating-point errors.
 */
class StiffenedGasSafe : public Material {
...
public:
   ...
   explicit StiffenedGasSafe( double const gamma, double const B, double const mu_shear, double const mu_bulk );
