 ...
 */
class StiffenedGasCompleteSafe : public Material {
...
public:
   ...
   explicit StiffenedGasCompleteSafe( double const gamma, double const A, double const B, double const C, double const specific_gas_constant, 
