...
/**
 * @brief The StiffenedGas class implements a generic stiffened gas, i.e. material parameters must be set via caller input.
 */
class StiffenedGas : public Material {
...
public:
   StiffenedGas() = delete;
   explicit StiffenedGas( double const gamma, double const B, double const mu_shear, double const mu_bulk );
