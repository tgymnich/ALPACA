...
*/
double FourthOrderCellFace::ApplyImplementation( std::vector<double> const& array, int const, int const, double const cell_size ) const {
   ...
   return (27.0 * ( array[downstream_stencil_size_ + 1] - array[downstream_stencil_size_ + 0] )
      - ( array[downstream_stencil_size_ + 2] - array[downstream_stencil_size_ - 1] )) / (cell_size * 24.0);
}
