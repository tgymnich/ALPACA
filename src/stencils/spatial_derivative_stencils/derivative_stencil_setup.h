...
namespace DerivativeStencilSetup {
   ...
   /**
    * @brief Function returning the typedef of a DerivativeStencil based on a constexpr template.
    * 
    * @tparam DerivativeStencils The constexpr template parameter to specify the exact DerivativeStencil type.
    */
   template<DerivativeStencils>
   struct Concretize;
    ...
    */
   template<>
   struct Concretize<DerivativeStencils::CentralDifference> {
    ...
    */
   template<>
   struct Concretize<DerivativeStencils::FourthOrderCellFace> {
    ...
    */
   template<>
   struct Concretize<DerivativeStencils::HOUC5> {
      typedef HOUC5 type;
   };
