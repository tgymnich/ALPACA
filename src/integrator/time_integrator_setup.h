...
/**
 * @brief A namespace to get a TimeIntegrator type based on a specified constexpr.
 */
namespace TimeIntegratorSetup {
    ...
    */
   template<>
   struct Concretize<TimeIntegrators::RK2> {
    ...
    */
   template<>
   struct Concretize<TimeIntegrators::RK3> {
